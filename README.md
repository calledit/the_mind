...
* Causality: There are 3 types of logical types of causes. They are necessary causes, sufficient causes and the combination of them necessary sufficient causes. Necessary causes deals with the time backwards; If B has happend A must have happend before. Sufficient causes deals with time moving forward; if A has happend, B will happen. Finally we have necessary sufficient causes; where A always leads to B and if B has happend A must have happend. When "cause" is talked about in natural language the type of cause that is talked about is often not of the logical types but a forth type called contributory cause. People often make erroneus conclusions steming from the fact that they where thinking of the "wrong" type of cause.
...
* Causal closure: in a causally closed system only things from inside the system can cause things to happen in the system. There are two forms of causal closure: the "stronger form" which is invalid(unless it is validated in a very strict context) and the "weaker form" which is more applicable. The weaker form allows one to map other causal systems on top of a causally closed system. So that the causal boundaries project down to the lower system. A event of trowing a baseball can for example be described as particles interacting in the lower system and as a baseball being thrown by a human in the higher level causal system. Causal closure is maintained in the lower system and cause and effect is valid in both the higher and the lower causal system.
...
One way of describing free will in a way that disconnects it from determinism is a perspective where "choice" and "will" are be described as a casual system where the choices we make have causal effect on the world, as such the choices you make have an effect on the world, things in the world would look different if you did not make the choices you made.
...
People often argue that you did not make the choice yourself, it was a chain of events that led to the choice that was not in your control. This is an argument that depends on a magic belief where the human that you are is separate from the world. But you are not simply human in this context, you are a choice maker, a decision process that evaluated concepts and models and made a weighted decision. The choice maker is a part of the human and the human is a part of the world so in a sense you are equally much the choice maker as you are the human as you are the world. The world can not predict its own true future and as such its future is not determined from it's own perspective, it is in a sense free as it is governed by it's own rules and not rules that is not it's own.

To answer the question "Do I have free will?", one must create definitions for "free", "will" and "I". It will be impossible to create a satisfactory answer without first doing that. If the borders around the "I" are not obvious and unless you specify those first it will be impossible for you to come to a conclusion about what being free from something outside of those borders might mean.
