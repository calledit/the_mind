...
People often argue that you did not make the choice yourself, it was a chain of events that led to the choice and that chain was not in your control. This is an argument that depends on a presuposition where the human that you are is separate from the world. But you are not simply human in this context, you are a choice maker, a decision process that evaluated concepts and models and made a weighted decision. The choice maker is a part of the human and the human is a part of the world. You are just as much a choice maker as you are a human and the choice maker is not solly bound to the human it is bound to the world. As described before the world can not predict its own true future and as such its future is not determined from it's own perspective; it is in a sense free as it is governed by it's own rules and not rules that is not it's own.
