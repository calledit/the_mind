...
### Identity
The identity of a certain thing is in fact not part of the thing itself it is part of a model that applies this identity. Examples of where this becomes a problem can be sen in the [Ship of Theseus](https://en.wikipedia.org/wiki/Ship_of_Theseus) thought experiment. These type of "paradoxes" arise due to the fact that we miscommunicate and misattribute the identity of things, implicitly switching between different modelling assumptions without noticing it. It is common to assume that the identity of a thing is bound to the physical thing that the thing is. So common and ingrained in society that it can be hard to not think of things like that. The identity of a thing is not directly bound to the physical, it is instead a perceptual phenomena. That perceptual phenomena arises in part because humans don’t live in the knife edge of time, we live in the perceptual space representing the few seconds/minutes just before the knife edge of time. As a result of this the way we perceive identity is bound to a timespan in the physical, not to the physical itself. We often don’t think about the world like that as it would be very convoluted and in 99.9% of cases misattributing identity to the physical works just fine anyway.
