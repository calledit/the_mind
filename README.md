...
* Personality, is a low resolution model of how you tend to behave based on your previous behaviour (although the tools that messure personality technically messure a persons belifs about its previous behaviour). The most well established personality system is "BIG 5". But there are other such systems, like the MBTI. The MTBI is older and is less "rigorous" but the BIG 5 and MTBI has some overlap, mainly on the extraversion/introversion dimension which are very similar in both systems but there is also some overlap in the dimension BIG-5-oppenness and MTBI-intuition/sensation. An article published September 2022 (doi.org/10.2466/08.09.PR0.107.5.578-586) indicates that these correlation are much weaker than prevoiusly thoght.
