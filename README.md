...
### The future
The future is not predictable: The future of a system that has recursion is not possible to predict to 100% without doing the recursion in some way. The system that is the universe contains recursion and can as such not be predicted. ie The things in the universe has to be simulated to the end of the outcome for the outcome to become certain. So a process that is analysing the system that is the universe from outside of the universe has to in some way run the universe to know where it is going. So while it might be true that the universe is deterministic, the only way to know where it will end up is by watching where it will go. i.e you cant know where the universe is going before having looked at the end result of where the universe went.
